      ...
      <div class="perfil-card">
        ...
        <div class="form-grid">
          ...
          <div class="input-group">
            ...
            <input v-model="usuario.nombre" type="text" class="input" />
          </div>
          ...
          <div class="input-group">
            ...
            <input v-model="usuario.email" type="email" class="input" />
          </div>
          ...
          <div class="input-group">
            ...
            <input v-model="usuario.telefono" type="text" class="input" />
          </div>
        ...
        <!-- BOTONES -->
        <div class="buttons">
          <button class="btn-save" @click="guardarPerfil" :disabled="loading">
...
const guardarPerfil = async () => {
  ...
  if (!usuario.value.email.includes("@")) {
