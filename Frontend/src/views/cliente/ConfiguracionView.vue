  ...
  <div class="config-container">
    ...
    <div class="config-card">
      ...
      <div class="input-group">
        <label>Nombre</label>
        <input v-model="nombre" type="text" class="input" placeholder="Tu nombre" />
      </div>

      <!-- EMAIL -->
      <div class="input-group">
        <label>Email</label>
        <input v-model="email" type="email" class="input" placeholder="correo@email.com" />
      </div>
...
/*
|--------------------------------------------------------------------------
| CARGAR USUARIO (backend o local)
|--------------------------------------------------------------------------
*/
