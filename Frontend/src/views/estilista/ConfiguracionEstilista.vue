      ...
      <div class="config-card">
        ...
        <div class="input-group">
          ...
          <input
            ...
            type="text"
            class="input"
            placeholder="Cortes, tintes, peinados..."
          />
        </div>
        ...
        <div class="input-group">
          ...
          <input
            ...
            type="email"
            class="input"
            placeholder="estilista@salon.com"
          />
        </div>
...
import MenuEstilista from '../../components/MenuEstilista.vue'

/* =========================
   CONFIG
========================= */

const API_URL = 'http://localhost:3000/api/estilistas'
...
const cargarLocal = async () => {
  ...
  const user = JSON.parse(
    localStorage.getItem('estilista') || '{}'
  )

  return {
    nombre: user.nombre || 'Estilista demo',
    especialidad: user.especialidad || 'Cortes',
    email: user.email || 'estilista@demo.com',
